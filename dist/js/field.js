...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    fieldValues: function fieldValues() {
      return Object.entries(this.field.value || {}).map(function (_ref) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    locales: function locales() {
      var _this$field$locales;
      if (this.currentField) {
        var _this$currentField$lo;
        return (_this$currentField$lo = this.currentField.locales) !== null && _this$currentField$lo !== void 0 ? _this$currentField$lo : [];
      }
      return (_this$field$locales = this.field.locales) !== null && _this$field$locales !== void 0 ? _this$field$locales : [];
    },
    key: function key() {
    ...
    localeErrors: function localeErrors() {
      var errors = this.errors.errors;
      if (!errors || !errors[this.field.attribute]) {
        return {};
      }
      var fieldErrors = errors[this.field.attribute];
      return fieldErrors.reduce(function (acc, error) {
        var obj = JSON.parse(error);
        var entries = Object.entries(obj);
        for (var _i = 0, _entries = entries; _i < _entries.length; _i++) {
          var _entries$_i = _slicedToArray(_entries[_i], 2),
            locale = _entries$_i[0],
            message = _entries$_i[1];
          if (!acc[locale]) {
            acc[locale] = [];
          }
  ...
  methods: {
    getLabelFor: function getLabelFor(locale) {
      return "".concat(this.field.uniqueKey, "-").concat(locale);
    },
    /*
    ...
    */
    setInitialValue: function setInitialValue() {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          this.value[locale] = ((_this$field$value = this.field.value) === null || _this$field$value === void 0 ? void 0 : _this$field$value[locale]) || '';
        }
      } catch (err) {
        _iterator.e(err);
      } finally {
    ...
    getErrors: function getErrors(locale) {
     ...
     */
    handleChangeMarkdown: function handleChangeMarkdown(value, locale) {
     ...
     * Update the field's internal value
     */
    handleChangeTextarea: function handleChangeTextarea(event, locale) {
     ...
     * Update the field's internal value
     */
    handleChange: function handleChange(event, locale) {
    ...
    initialize: function initialize(locale) {
      var _this$value$locale;
      var mdEditor = this.$refs["mdEditor-".concat(locale)];
      if (!(mdEditor !== null && mdEditor !== void 0 && mdEditor.length)) {
        return;
      }
      mdEditor[0].setValue((_this$value$locale = this.value[locale]) !== null && _this$value$locale !== void 0 ? _this$value$locale : this.currentField.value[locale]);
      Nova.$on("".concat(this.fieldAttributeValueEventName, ":").concat(locale), this.listenToValueChanges);
    },
    ...
    fetchPreviewContent: function fetchPreviewContent(value) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var _yield$Nova$request$p, preview;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              Nova.$progress.start();
              _context.next = 3;
              return Nova.request().post("/nova-api/".concat(_this.resourceName, "/field/").concat(_this.fieldAttribute, "/preview"), {
                value: value
              }, {
                params: {
                  editing: true,
                  editMode: lodash_isNil__WEBPACK_IMPORTED_MODULE_0___default()(_this.resourceId) ? 'create' : 'update'
                }
              });
            case 3:
  ...
  beforeUnmount: function beforeUnmount() {
    ...
    this.locales.forEach(function (locale) {
      Nova.$off("".concat(_this2.fieldAttributeValueEventName, ":").concat(locale), _this2.listenToValueChanges);
    });
  }
});
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_PanelItem, {
    ...
    value: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [$options.fieldValues.length > 0 ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_FormKeyValueTable, {
        key: 0,
        "edit-mode": false,
        ...
        "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_FormKeyValueHeader, {
            "key-label": _ctx.__('Locale'),
            "value-label": _ctx.__('Translation')
          }, null, 8 /* PROPS */, ["key-label", "value-label"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.fieldValues, function (item, index) {
...
var _hoisted_2 = ["id", "dusk", "value", "onInput", "maxlength", "placeholder"];
var _hoisted_3 = ["id", "type", "placeholder", "onUpdate:modelValue"];
function render(_ctx, _cache, $props, $setup, $data, $options) {
  var _component_FormLabel = (0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveComponent)("FormLabel");
  var _component_MarkdownEditor = (0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveComponent)("MarkdownEditor");
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: $options.locales.length
  }, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.locales, function (locale) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultField, {
      ...
      field: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
        return [$options.inputType === 'textarea' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("textarea", (0,vue__WEBPACK_IMPORTED_MODULE_0__.mergeProps)({
          key: 0,
          ref_for: true
        }, _ctx.extraAttributes, {
          "class": "block w-full form-control form-input form-control-bordered py-3 h-auto",
          id: $options.getLabelFor(locale),
          dusk: _ctx.field.attribute,
          value: _ctx.value[locale],
          onInput: function onInput($event) {
            return $options.handleChange($event, locale);
          },
          maxlength: _ctx.field.enforceMaxlength ? _ctx.field.maxlength : -1,
          placeholder: _ctx.placeholder
        }), null, 16 /* FULL_PROPS */, _hoisted_2)) : $options.inputType === 'markdown' ? (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)(((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_MarkdownEditor, {
          key: 1,
          ref_for: true,
          ref: "mdEditor-".concat(locale),
          "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)({
            'form-control-bordered-error': _ctx.hasError
          }),
          id: $options.getLabelFor(locale),
          previewer: _ctx.previewer,
          readonly: _ctx.currentlyIsReadonly,
          onInitialize: function onInitialize($event) {
            return $options.initialize(locale);
          },
          onChange: function onChange($event) {
            return $options.handleChange($event, locale);
          }
        }, null, 8 /* PROPS */, ["class", "id", "previewer", "readonly", "onInitialize", "onChange"])), [[vue__WEBPACK_IMPORTED_MODULE_0__.vShow, _ctx.currentlyIsVisible]]) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)(((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("input", {
          key: 2,
          id: $options.getLabelFor(locale),
          ...
          placeholder: _ctx.field.name,
          "onUpdate:modelValue": function onUpdateModelValue($event) {
            return _ctx.value[locale] = $event;
          }
        }, null, 10 /* CLASS, PROPS */, _hoisted_3)), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelDynamic, _ctx.value[locale]]]), $options.localeErrors[locale] ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_HelpText, {
          key: 3,
          "class": "help-text-error"
        }, {
          "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
            return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.localeErrors[locale][0]), 1 /* TEXT */)];
          }),
          _: 2 /* DYNAMIC */
        }, 1024 /* DYNAMIC_SLOTS */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)];
      }),
      "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
        return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_FormLabel, {
          "label-for": $options.getLabelFor(locale),
          "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["space-x-1", {
            'mb-2': _ctx.shouldShowHelpText
          }])
        }, {
          "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
            return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)("".concat($options.fieldName, " (").concat(locale.toUpperCase(), ")")), 1 /* TEXT */), _ctx.field.required ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_1, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.__('*')), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)];
          }),
          _: 2 /* DYNAMIC */
        }, 1032 /* PROPS, DYNAMIC_SLOTS */, ["label-for", "class"])];
      }),
      _: 2 /* DYNAMIC */
    }, 1032 /* PROPS, DYNAMIC_SLOTS */, ["field", "show-help-text", "full-width-content"]);
  }), 128 /* KEYED_FRAGMENT */))]);
}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.displayAs), 1 /* TEXT */);
}
...
/* harmony import */ var _Users_andy_Development_Packages_laravel_translatable_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,_Users_andy_Development_Packages_laravel_translatable_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_DetailField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_DetailField_vue_vue_type_template_id_0224618e__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/DetailField.vue"]])
/* hot reload */
if (false) {}
...
Nova.booting(function (app, store) {
  app.component('index-translatable-field', _components_IndexField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('detail-translatable-field', _components_DetailField__WEBPACK_IMPORTED_MODULE_1__["default"]);
  app.component('form-translatable-field', _components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"]);
});
})();
